    ...
    <div class="container mt-5">
        ...
        <form method="post" action='<?php echo $_SERVER["PHP_SELF"]; ?>'>
            <div class="form-group col-xs-3 form-inline m-2">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput" name="login" placeholder="Digite seu Login" required><br><br>
            </div>
        ...
        <div id="list-example" class="ml-2 nav">
            <h2><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>:8080" class="m-2"><i class="fa fa-database" aria-hidden="true"></i></a></h2>
